...
import { createQuickPick } from '../../../../actions/quickPickAction'
...
class QuickPicksForm extends Component {
    ...
    handleClickQP = () => {
        ...
        this.props.createQuickPick(userData)
                    ...
                    <Container>
                        <Grid container>
                            ...
                            <Grid item xs={12} align='center'>
                                <Typography align='center' variant='h3'>Create QuickPick</Typography>
                            </Grid>
...
export default connect(mapStateToProps, { createQuickPick })(withRouter(QuickPicksForm))
